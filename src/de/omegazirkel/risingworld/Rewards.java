...
public class Rewards extends Plugin implements Listener, FileChangeListener {
    public static final String PLUGIN_IDENTIFIER = "OZ - Rewards";
    public static final String COMMAND = "rewards";
    public static final String LOGIN_LAST_GMT_DATE_KEY = "oz.rewards.login.lastGmtDate";
    public static final String LOGIN_STREAK_COUNT_KEY = "oz.rewards.login.streakCount";
    public static final String ORBIT_REACHED_AT_KEY = "oz.rewards.milestone.orbit.reachedAt";
    public static final String HELL_REACHED_AT_KEY = "oz.rewards.milestone.hell.reachedAt";
